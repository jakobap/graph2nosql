...
class _NoSQLKnowledgeGraphTests(ABC):
    ...
    def test_update_node(self):
        ...
        self.kg.update_node(node_uid="test_update_node_1",
                            node_data=updated_node_data)

        # Retrieve the node again and verify the update
        retrieved_updated_node_data = self.kg.get_node(
            node_uid="test_update_node_1")
        self.assertEqual(retrieved_updated_node_data,
                         updated_node_data)  # type: ignore
    ...
    def test_add_node_with_edge(self):
        ...
        # type: ignore # Adjust exception type if needed
    ...
    def test_add_direcred_edge(self):
        ...
        self.kg.add_node(node_uid="test_directed_node_1",
                         node_data=node_data_1)
        self.kg.add_node(node_uid="test_directed_node_2",
        ...
        # Clean Up egdes
        self.kg.remove_edge(source_uid="test_directed_node_1",
                            target_uid="test_directed_node_2")
    ...
    def test_add_undirecred_edge(self):
        ...
        self.kg.add_node(node_uid="test_undirected_node_1",
                         node_data=node_data_1)
        self.kg.add_node(node_uid="test_undirected_node_2",
                         node_data=node_data_2)
        ...
        self.assertIn("test_undirected_node_1",
                      node2.edges_from)  # type: ignore
        self.assertIn("test_undirected_node_2",
                      node1.edges_from)  # type: ignore

        # Clean Up egdes
        self.kg.remove_edge(source_uid="test_undirected_node_1",
                            target_uid="test_undirected_node_2")
    ...
    def test_get_edge(self):
        ...
        new_edge_uid = self.kg._generate_edge_uid(source_uid=edge_data.source_uid,
        ...
        # Clean up edges
        self.kg.remove_edge(source_uid="test_getedge_node_1",
                            target_uid="test_getedge_node_2")
    ...
    def test_update_edge(self):
        ...
        self.kg.add_node(node_uid="test_edgeupdate_node_1",
                         node_data=node_data_1)
        self.kg.add_node(node_uid="test_edgeupdate_node_2",
                         node_data=node_data_2)
        ...
        # Cleanup edges
        self.kg.remove_edge(source_uid="test_edgeupdate_node_1",
                            target_uid="test_edgeupdate_node_2")
    ...
    def test_remove_edge(self):
        ...
        self.kg.add_node(node_uid="test_removeegde_node_1",
                         node_data=node_data_1)
        self.kg.add_node(node_uid="test_removeegde_node_2",
                         node_data=node_data_2)
        ...
        self.assertIn("test_removeegde_node_2",
                      node1.edges_from)  # type: ignore

        # Remove the edge
        self.kg.remove_edge(source_uid="test_removeegde_node_2",
                            target_uid="test_removeegde_node_1")

        # Assert that the edge is no longer in the nodes' edge lists
        node1 = self.kg.get_node("test_removeegde_node_1")
        node2 = self.kg.get_node("test_removeegde_node_2")
        self.assertNotIn("test_removeegde_node_2",
                         node1.edges_to)  # type: ignore
        self.assertNotIn("test_removeegde_node_2",
                         node1.edges_from)  # type: ignore
        self.assertNotIn("test_removeegde_node_1",
                         node2.edges_from)  # type: ignore
        self.assertNotIn("test_removeegde_node_1",
    ...
    def test_get_networkx(self):
        ...
        self.assertTrue(self.kg.networkx.has_node(
            "test_getnx_node_1"))  # type: ignore
        self.assertTrue(self.kg.networkx.has_node(
            "test_getnx_node_2"))  # type: ignore
        # Check if a specific edge exists in the graph
        self.assertTrue(self.kg.networkx.has_edge(
            "test_getnx_node_1", "test_getnx_node_2"))  # type: ignore

        # 5. Clean up (optional, depending on your test setup)
        self.kg.remove_edge(source_uid="test_getnx_node_1",
                            target_uid="test_getnx_node_2")
    ...
    def test_get_louvain_communities(self):
        ...
        # 5. Clean up (optional, depending on your test setup)
        self.kg.remove_edge(source_uid="test_louvain_node_1",
                            target_uid="test_louvain_node_2")
        self.kg.remove_edge(source_uid="test_louvain_node_2",
                            target_uid="test_louvain_node_3")
    ...
    def test_visualize_graph(self):
        ...
        self.kg.remove_edge(source_uid="test_vis_node_1",
                            target_uid="test_vis_node_2")
        self.kg.remove_edge(source_uid="test_vis_node_2",
                            target_uid="test_vis_node_3")
